...
import (
	...
	"github.com/stormasm/nomsleveldb/cmd/noms/diff"
	...
	"github.com/stormasm/nomsleveldb/go/util/orderedparallel"
	"github.com/stormasm/nomsleveldb/go/util/outputpager"
	"github.com/stormasm/nomsleveldb/go/util/verbose"
	"github.com/stormasm/nomsleveldb/go/util/writers"
...
var nomsLog = &util.Command{
	...
	Long:      "commitObject must be a dataset or object spec that refers to a commit. See Spelling Objects at https://github.com/stormasm/nomsleveldb/blob/master/doc/spelling.md for details.",
	Flags:     setupLogFlags,
	Nargs:     1,
}
