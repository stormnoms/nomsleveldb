...
import (
	...
	"github.com/stormasm/nomsleveldb/go/perf/suite"
	"github.com/stormasm/nomsleveldb/go/types"
	"github.com/stormasm/nomsleveldb/samples/go/csv"
...
func (s *perfSuite) SetupSuite() {
	...
	err := exec.Command("go", "build", "-o", s.csvImportExe, "github.com/stormasm/nomsleveldb/samples/go/csv/csv-import").Run()
